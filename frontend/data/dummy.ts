...
export const signals: Signal[] = [
  {
    ...
    timeAgo: '2h',
    explanation:
      "ETF inflows into AI tokens spiked 40% this week while price hasn't reacted. Historically, price follows inflows in 3–5 days. BTC treasuries stable → macro not bearish. No negative news.",
    dataSources: [
  ...
  },
  {
    ...
    timeAgo: '5h',
    explanation:
      'VC activity picked up with 3 new funding rounds totaling $48M this week. Capital rotation into DeFi from L2 signals smart money repositioning. Price action flat — no breakout yet.',
    dataSources: [
  ...
  },
  {
    ...
    timeAgo: '1d',
    explanation:
      'ETF outflows from L2 tokens accelerating — $89M net outflow over 7 days. VC activity dried up. Macro rate uncertainty adding pressure. Smart money rotating out.',
    dataSources: [
  ...
  },
  {
    ...
    timeAgo: '2d',
    explanation:
      'BTC ETF inflows strong at $570M weekly. Corporate treasury purchases continue. However, FOMC meeting in 7 days introduces macro uncertainty — wait for clearer signal post-Fed.',
    dataSources: [
  ...
  },
  {
    ...
    timeAgo: '3d',
    explanation:
      'Real-world asset tokenization narrative gaining momentum with $15M VC round this week. Regulatory clarity improving. Inflows modest but consistent.',
    dataSources: [
...
export const macroStatus: MacroItem[] = [
